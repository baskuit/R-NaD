...
# Lets us know what alpha to use and also a bool whether to update net, net_target
...
class RNaDSolver(policy_lib.Policy):
  ...
  def loss(self, params: Params, params_target: Params, params_prev: Params,
    ...
    for player in range(self._game.num_players()):
      reward = ts.actor.rewards[:, :, player]  # [T, B, Player] bullet1 origin of rewards
    ...
    return loss_v + losts.env.s_nerd
